        ...
        <>
            <div className="relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden">
                <div className="absolute inset-0 -z-10 bg-gradient-to-br from-purple-900 via-black to-black opacity-90" style={{ width: '100%', height: '1000px' }}>
                    <DarkVeil speed={0.5} warpAmount={3} noiseIntensity={0.2} />
                </div>
                <Navbar />
                ...
                <h1 className="mt-6 text-4xl md:text-5xl font-extrabold text-white leading-snug max-w-2xl">
                    Become emboldened by <br /> the flame of ambition
                </h1>
